...
const MEBA_FINANS: FirmaFinans = {
  ...
  urunMarji: uretUrunMarji(
    [
      { kod: "SMC-CDQ2B25-50DM", ad: "SMC Pnömatik Silindir Ø25×50", segment: "Pnömatik Silindir", birimFiyat: 2_400, marj: 22.5, trend: 8.2 },
      { kod: "SMC-VQ7-6-FG", ad: "SMC Solenoid Valf VQ7", segment: "Solenoid Valf", birimFiyat: 4_800, marj: 24.0, trend: 5.4 },
      { kod: "SMC-AF30-03BD", ad: "SMC Hava Hazırlık Modülü AF30", segment: "Hava Hazırlık", birimFiyat: 1_200, marj: 19.8, trend: -2.1 },
      { kod: "SMC-MGPM25-50", ad: "SMC Kılavuzlu Silindir MGP", segment: "Pnömatik Silindir", birimFiyat: 5_600, marj: 26.5, trend: 12.5 },
      { kod: "SMC-CXSM15", ad: "SMC Çift Şaftlı Silindir CXS", segment: "Pnömatik Silindir", birimFiyat: 3_800, marj: 21.2, trend: 4.0 },
      { kod: "SMC-MHZ2-25D", ad: "SMC Pnömatik Gripper MHZ2", segment: "Gripper", birimFiyat: 6_400, marj: 28.4, trend: 15.8 },
      { kod: "SMC-IZS40-1100", ad: "SMC İyonizer Bar IZS40", segment: "İyonizer", birimFiyat: 12_500, marj: 18.0, trend: 6.5 },
      { kod: "SMC-XSA-10C", ad: "SMC Vakum Pompası XSA", segment: "Vakum", birimFiyat: 8_200, marj: 23.5, trend: 9.0 },
      { kod: "SMC-PFM710-N7", ad: "SMC Akış Sensörü PFM", segment: "Sensör", birimFiyat: 3_400, marj: 25.5, trend: 11.0 },
      { kod: "SMC-IRV20-08BG", ad: "SMC Vakum Regülatör IRV", segment: "Vakum", birimFiyat: 4_100, marj: 20.5, trend: 3.2 },
    ],
    1_200,
    ["ELMOS Otomasyon", "MESA Enerji", "Kayseri OSB A", "Konya Bayi", "Ankara Dağıtım"],
  ),
...
const MESA_FINANS: FirmaFinans = {
  ...
  urunMarji: uretUrunMarji(
    [
      { kod: "MESA-PLC-S7-1500", ad: "Siemens S7-1500 PLC Sistemi", segment: "PLC / Otomasyon", birimFiyat: 85_000, marj: 28.5, trend: 11.0 },
      { kod: "MESA-SCADA-PCS7", ad: "PCS7 SCADA Lisansı + Mühendislik", segment: "SCADA", birimFiyat: 240_000, marj: 32.0, trend: 6.5 },
      { kod: "MESA-HMI-KTP1200", ad: "HMI Panel + Programlama", segment: "HMI", birimFiyat: 32_000, marj: 24.0, trend: 8.0 },
      { kod: "MESA-MOTOR-22KW", ad: "AC Motor + Sürücü 22kW Paket", segment: "Motor Sürücü", birimFiyat: 145_000, marj: 18.5, trend: 4.2 },
      { kod: "MESA-MCC-PANEL", ad: "MCC Pano Üretim + Devreye Alma", segment: "Pano", birimFiyat: 380_000, marj: 22.5, trend: 12.5 },
      { kod: "MESA-DEVALMA", ad: "Saha Devreye Alma Mühendislik", segment: "Hizmet", birimFiyat: 95_000, marj: 45.0, trend: 18.0 },
      { kod: "MESA-BAKIM-YIL", ad: "Yıllık Bakım Kontratı (12 ay)", segment: "Bakım", birimFiyat: 280_000, marj: 38.5, trend: 22.0 },
      { kod: "MESA-PROFINET-SET", ad: "Profinet Ağ Kurulum Paketi", segment: "Endüstriyel Ağ", birimFiyat: 64_000, marj: 26.0, trend: 7.5 },
      { kod: "MESA-ENERJI-AUDIT", ad: "Enerji Verimlilik Etütü", segment: "Mühendislik", birimFiyat: 48_000, marj: 52.0, trend: 35.0 },
      { kod: "MESA-RETROFIT", ad: "Eski Sistem Retrofit Paketi", segment: "Retrofit", birimFiyat: 175_000, marj: 30.5, trend: 9.0 },
    ],
    18,
    ["Endüstri Tesisleri A", "Su Kurumu", "Enerji Dağıtım", "OSB Fabrika B", "Bakım Müşterileri"],
  ),
...
const ELMOS_FINANS: FirmaFinans = {
  ...
  urunMarji: uretUrunMarji(
    [
      { kod: "ELMOS-MM-CNC4X", ad: "CNC İşleme Merkezi 4 Eksen", segment: "Özel Makine", birimFiyat: 1_850_000, marj: 22.0, trend: 14.5 },
      { kod: "ELMOS-MM-HIDR", ad: "Hidrolik Pres 250 ton", segment: "Hidrolik", birimFiyat: 980_000, marj: 19.5, trend: 6.0 },
      { kod: "ELMOS-MM-MONTAJ", ad: "Otomatik Montaj Hattı", segment: "Otomasyon", birimFiyat: 2_400_000, marj: 24.5, trend: 18.0 },
      { kod: "ELMOS-MM-PAKET", ad: "Dikey Paketleme Makinesi", segment: "Paketleme", birimFiyat: 540_000, marj: 17.5, trend: 4.5 },
      { kod: "ELMOS-MM-TEST", ad: "Vision Test İstasyonu", segment: "Vision Test", birimFiyat: 680_000, marj: 28.5, trend: 22.0 },
      { kod: "ELMOS-YP-CNC", ad: "CNC Yedek Parça Seti", segment: "Yedek Parça", birimFiyat: 12_500, marj: 35.0, trend: 8.5 },
      { kod: "ELMOS-YP-HID", ad: "Hidrolik Sızdırmazlık Seti", segment: "Yedek Parça", birimFiyat: 4_800, marj: 40.5, trend: 12.0 },
      { kod: "ELMOS-SRV-YIL", ad: "Yıllık Servis Kontratı", segment: "Servis", birimFiyat: 145_000, marj: 48.0, trend: 25.0 },
      { kod: "ELMOS-MOD-RETRO", ad: "Eski Makine Modernizasyon", segment: "Retrofit", birimFiyat: 320_000, marj: 32.5, trend: 16.0 },
      { kod: "ELMOS-PROJ-OZEL", ad: "Sipariş Üzerine Özel Makine", segment: "Özel Üretim", birimFiyat: 3_200_000, marj: 26.0, trend: 11.5 },
    ],
    9,
    ["OSB Sanayi A", "OSB Sanayi B", "Yurt Dışı Sipariş", "MESA Enerji", "Servis Müşterileri"],
  ),
...
const ARKON_FINANS: FirmaFinans = {
  ...
  urunMarji: uretUrunMarji(
    [
      { kod: "ARKON-LENZE-INV", ad: "Lenze Frekans İnvertörü", segment: "Motor Sürücü", birimFiyat: 38_000, marj: 18.5, trend: 6.5 },
      { kod: "ARKON-HON-DCS", ad: "Honeywell DCS Mühendislik", segment: "DCS", birimFiyat: 480_000, marj: 28.0, trend: 8.0 },
      { kod: "ARKON-PHO-PLC", ad: "Phoenix Endüstriyel PLC", segment: "PLC", birimFiyat: 65_000, marj: 22.5, trend: 4.5 },
      { kod: "ARKON-VISION-KEYENCE", ad: "Vision Kamera (Keyence)", segment: "Vision", birimFiyat: 145_000, marj: 30.5, trend: 18.0 },
      { kod: "ARKON-MOTION-SET", ad: "Motion Control Çoklu Eksen", segment: "Motion", birimFiyat: 92_000, marj: 26.0, trend: 12.5 },
      { kod: "ARKON-PROJ-OZEL", ad: "Konya Bölge Otomasyon Proje", segment: "Proje", birimFiyat: 580_000, marj: 24.5, trend: 9.0 },
      { kod: "ARKON-VISION-LICENSE", ad: "Vision Yazılım Lisansı Yıllık", segment: "Yazılım", birimFiyat: 28_000, marj: 55.0, trend: 32.0 },
      { kod: "ARKON-EGITIM", ad: "PLC + Vision Eğitim", segment: "Eğitim", birimFiyat: 18_500, marj: 60.0, trend: 28.0 },
      { kod: "ARKON-BAKIM", ad: "Yıllık Saha Bakım Kontratı", segment: "Bakım", birimFiyat: 95_000, marj: 42.5, trend: 16.0 },
      { kod: "ARKON-YP-SUR", ad: "Sürücü Yedek Parça", segment: "Yedek Parça", birimFiyat: 6_800, marj: 38.0, trend: 7.5 },
    ],
    12,
    ["Konya OSB A", "Konya OSB B", "Aksaray Sanayi", "Niğde Müşteri", "Vision Proje"],
  ),
